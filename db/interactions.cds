...
@cds.persistence.exists /// Esta anotacion permite redefinir una DB existente y CDS no intentara crear o alterarla. Va a asumir que ya existe en el estado de maquina.
@cds.persistence.calcview /// Esta anotacion le dice al CAP que la entidad apuntada es tambien un Calculation View
